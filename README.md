...
- **Tanya data dengan AI** — chatbot berbasis Gemma 3N E4B (NVIDIA) yang memahami isi tabel dan menjawab pertanyaan dalam bahasa Indonesia:
...
NVIDIA menyediakan akses ke berbagai model AI besar, termasuk Gemma 3N E4B, melalui platform NVIDIA API Catalog.
...
**Catatan teknis:**
- Model utama: `google/gemma-3n-e4b-it`. Jika model sedang tidak tersedia (DEGRADED), sistem otomatis mencoba `meta/llama-3.1-70b-instruct` lalu `meta/llama-3.1-8b-instruct`.
